...
function App() {
  ...
  const [data, setData] = useState([{ name: 'Producto 1', category: 'Categoría 1', stock: 10, img: 'Marca 1', price: 100 },
  { name: 'Producto 5', category: 'Categoría 2', stock: 20, img: 'Marca 2', price: 200 },
